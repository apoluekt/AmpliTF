...
def cos_theta_12(M, m1, m2, m3, sigma1, sigma2, sigma3) : 
  return (2*sigma3*(sigma2-m3**2-m1**2)-(sigma3+m1**2-m2**2)*(M**2-sigma3-m3**2))/\
         sqrt(kallen_function(M**2, m3**2, sigma3)*kallen_function(sigma3, m1**2, m2**2))
...
def cos_theta_hat_3_canonical_1(M, m1, m2, m3, sigma1, sigma2, sigma3) : 
  return ((M**2+m3**2-sigma3)*(M**2+m1**2-sigma1)-2*M**2*(sigma2-m3**2-m1**2))/\
         sqrt(kallen_function(M**2, m1**2, sigma1)*kallen_function(M**2, sigma3, m3**2))
