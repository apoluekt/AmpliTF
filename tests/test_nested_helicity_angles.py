...
p2 = np.array( [ [-0.305812, 0.284, 0.284, 0.755744], [-0.305812, 0.284, 0.284, 0.755744] ])
p3 = np.array( [ [-0.061663, -0.0211864, -0.0211864, 0.208274], [-0.061663, -0.0211864, -0.0211864, 0.208274] ] )
p4 = np.array( [ [-0.146733, -0.0785946, -0.0785946, 0.777613], [-0.146733, -0.0785946, -0.0785946, 0.777613] ] )
...
print(np.cos(angles[0].numpy()), angles[1].numpy(), np.cos(
    angles[2].numpy()), angles[3].numpy(), np.cos(angles[4].numpy()), angles[5].numpy())
